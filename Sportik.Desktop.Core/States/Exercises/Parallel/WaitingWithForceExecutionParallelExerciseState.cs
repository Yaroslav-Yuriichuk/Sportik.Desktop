...
namespace Sportik.Desktop.Core.States.Exercises.Parallel
{
    internal sealed class WaitingWithForceExecutionParallelExerciseState : ParallelExerciseState
    {
        ...
        public override Exercises.ParallelExerciseState ExerciseState => Exercises.ParallelExerciseState.WaitingWithForceExecution;

        public WaitingWithForceExecutionParallelExerciseState(ParallelExerciseStatesContext context, IEventsService eventsService,
